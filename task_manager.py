...
#the usernames and passwords are stored in a text file called "user.txt" in the order of (username, comma, space, password)#
...
#with open("user,txt","r") as f: (this opens the text file user.txt and stores the username and password provided by the user#
...
#If the value entered to confirm the password matches the value of the password, both the username and password are stored in a text file called "user.txt" #

#to store the username and password in a user.txt file, with open("user.txt", "a+") as f: is used to open the user.txt file and "a+" is used to add the data to the user.txt file#
...
#all these data is stored in a text file called "tasks.txt" #

#to store these data with open("tasks.txt", "a+") as f: is used to open the tasks.txt file and "a+" is used to add the data to tasks.txt file#
...
#to view all tasks the task.txt file is opened using, with open("tasks.txt", "r") as f: and a for loop is used to loop over the lines#
...
#to do this "tasks.txt" file must be opened using with open("tasks.txt", "r") as f:, "r" reads the tasks file#

#readlines() function is used to read the lines in tasks.txt file#
